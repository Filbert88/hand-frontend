...
import { Search, ShoppingCart, Minus, Plus, Clock } from "lucide-react";
...
export default function EnhancedMedicationSearch() {
  ...
  const confirmAddToCart = () => {
    ...
    const existingItem = newCart.find(
      (item) => item.id === selectedMedication?.id
    );
    ...
    <div className="min-h-screen bg-[#FFF2F7] font-gloock">
      <div className="px-10 py-20 md:py-30 md:px-20 lg:py-36 lg:px-40">
        <div className="flex flex-row justify-between items-center mb-4">
          <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-6xl xl:text-7xl font-bold mb-4">
            What do you need?
          </h1>
        ...
        <div className="flex flex-wrap flex-row sm:justify-start justify-center w-full gap-5 ">
          {medications
            ...
            .map((med) => (
              <div
                key={med.id}
                className="bg-[#FFD3E4] rounded-lg shadow-md w-[250px] overflow-hidden"
              >
                <Image
                  src={med.image_url}
                  alt={med.name}
                ...
                <div className="p-4">
                  ...
                  <div className="flex w-full gap-3">
                    ...
                    <button className="bg-gray-100 text-gray-600 w-full px-4 py-1 rounded-lg text-sm">
                      More
                    </button>
                  </div>
                </div>
