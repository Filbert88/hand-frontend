...
const AdminCard: React.FC<AdminCardProps> = ({ title, src, color, onClick }) => (
  <div 
  ...
  return (
    <div className="min-h-screen bg-[#524B4B] pt-28">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-bold text-[#FFEFE5] mb-8 text-center font-gloock">Hello, Admin!</h1>
